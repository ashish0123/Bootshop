...
<meta charset="utf-8">
 <meta name="viewport" content="width=device-width, initial-scale=1">
  ...
  <link rel="stylesheet" href="<?= base_url('themes/admin/css/sidebar-menu.css'); ?>">
</head>
<body>
<div class="container-fluid">
   <div class="row header">
     ...
     <div class="sm-col-6" style="float:left;">
      <span><img src="<?= base_url('themes/admin/images/logo.png'); ?>" class="img-responsive" width="90%" alt="logo"/></span>
	  <h3>E-Mall</h3>
     </div>
	 
	 <div class="sm-col-6" style="float:right;">
	 
	  <p> <i class="fa fa-user" aria-hidden="true">&nbsp;&nbsp; Hello <?php echo $this->session->userdata('admin_name');?> &rsaquo;&rsaquo; <a href="<?= base_url('admin/logout'); ?>" style="text-decoration:none"><i class="fa fa-power-off" aria-hidden="true" style="font-size:20px;" >&nbsp;&nbsp;Logout</i></a></i></p>  
	 </div>
