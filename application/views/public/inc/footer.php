...
<!-- Placed at the end of the document so the pages load faster ============================================= -->
	<script src="<?= base_url('themes/js/jquery.js" type="text/javascript'); ?>"></script>
	<script src="<?= base_url('themes/js/bootstrap.min.js" type="text/javascript'); ?>"></script>
	<script src="<?= base_url('themes/js/google-code-prettify/prettify.js'); ?>"></script>
	<script src="<?= base_url('themes/js/bootshop.js'); ?>"></script>
    <script src="<?= base_url('themes/js/jquery.lightbox-0.5.js'); ?>"></script>
