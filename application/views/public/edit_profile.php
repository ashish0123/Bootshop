...
?>
 <form action="<?= base_url('Profile/update'); ?>" method="post">
	<table class="table">
	  <tr>
		  <td colspan="3" >
		  <h2 style=" margin:0">Update Your Profile </h2>
		 
		  <a href="<?= base_url('OfflinePayment');?>" class="btn" style="background:#0066FF; text-shadow:none; padding:8px 10px; font-size:20px;color:#FFF; float:right"><i class="icon-arrow-left"></i> Back To Cart</a> </td>
	  </tr>
	  <tr>
	  ...
	  <tr>
		  ...
		  <td>
			...
			<option value="">-</option>
			<option selected="selected" style="background:#00FF33" value="<?php echo $customerData->title; ?>"><?php echo $customerData->title; ?></option>
	  ...
	  <tr>
		  ...
		  <td><input type="text" name="fname" value="<?php echo $customerData->fname; ?>"></td>
	  </tr>
	  
	  <tr>
		  <td style="vertical-align:middle">Last Name : </td>
		  <td><input type="text" name="lname" value="<?php echo $customerData->lname; ?>"></td>
	  </tr>
	  
	  <tr>
		  <td style="vertical-align:middle">Email : </td>
		  <td><input type="text" name="email" value="<?php echo $customerData->email; ?>"></td>
	  </tr>

	  <tr>
		  <td style="vertical-align:middle">Date Of Birth : </td>
		  <td><input type="date" name="dob" placeholder="dd-mm-yyyy" value="<?php echo $customerData->dob; ?>"></td>
	  </tr>
	  
	  
	  <tr>
		  <td style="vertical-align:middle">Address 1 : </td>
		  <td><input type="text" name="address1" value="<?php echo $customerData->address1; ?>"></td>
	  </tr>
	  
	  <tr>
		  <td style="vertical-align:middle">Address 2 : </td>
		  <td><input type="text" name="address2" value="<?php echo $customerData->address2; ?>"></td>
	  </tr>
	  
	  <tr>
		  <td style="vertical-align:middle">City : </td>
		  <td><input type="text" name="city" value="<?php echo $customerData->city; ?>"></td>
	  </tr>
	  
	  <tr>
		  <td style="vertical-align:middle">State : </td>
		  <td><input type="text" name="state" value="<?php echo $customerData->state; ?>"></td>
	  </tr>
	  
	  <tr>
		  <td style="vertical-align:middle">Pin/Postal code : </td>
		  <td><input type="text" name="pin" value="<?php echo $customerData->pin; ?>"></td>
	  </tr>
	  ...
	  <tr>
		  ...
		  <td>
		       <select name="country" id="state" >
				<option value="">-</option>
				<option selected="selected" value="<?php echo $customerData->country; ?>"><?php echo $customerData->country; ?></option>
	  ...
	  <tr>
		  ...
		  <td><input type="text" name="phone" value="<?php echo $customerData->phone; ?>"></td>
	  </tr>
	  
	  <tr>
	      <td></td>
	      <td><button name="update" value="update" style="background:#CCCCCC; border-radius:5px; border:none; padding:7px 5px;">Update</button></td>
	  </tr>	  
</table>
</form>	
<?php }} ?>  	 
