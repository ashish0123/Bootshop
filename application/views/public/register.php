...
<div class="span9">
	...
	<div class="well">
	<form action="<?= base_url('user/addUser');?>" method="post" class="form-horizontal" >
		...
		<div class="control-group">
		 ...
		 <div class="control-group">
			...
			<div class="controls">
			  <input type="text" name="lname" id="inputLnam" placeholder="Last Name">
			</div>
		 </div>
		<div class="control-group">
	...
	<div class="control-group">
		...
		<input type="date" name="dob" data-date-inline-picker="true" placeholder="dd-mm-yyyy" />
...
<?php } ?>
		...
		<div class="control-group">
			...
			<div class="controls">
			  <input type="text" name="address1" id="address" placeholder="Address"/> <span>Street address, P.O. box, company name, c/o</span>
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
			  <input type="text" name="address2" id="address2" placeholder="Address line 2"/> <span>Apartment, suite, unit, building, floor, etc.</span>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
			  <input type="text" name="pin" id="postcode" placeholder="Zip / Postal Code"/> 
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
			  <input type="text"  name="phone" id="phone" placeholder="phone"/> <span>You must register phone number</span>
			</div>
		</div>
